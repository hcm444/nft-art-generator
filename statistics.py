...
def statictics(NFT_array):
    ...
    stat_body = [body_array.count(1), body_array.count(2), body_array.count(3), body_array.count(4),
                 body_array.count(5)]
    stat_eyes = [eyes_array.count(1), eyes_array.count(2), eyes_array.count(3), eyes_array.count(4),
                 eyes_array.count(5)]
    stat_mouth = [mouth_array.count(1), mouth_array.count(2), mouth_array.count(3), mouth_array.count(4),
                  mouth_array.count(5)]
    stat_nose = [nose_array.count(1), nose_array.count(2), nose_array.count(3), nose_array.count(4),
                 nose_array.count(5)]
